...
public class FileController {
    ...
    public String upload(@RequestParam MultipartFile file,@PathVariable Integer id) throws IOException {
       ...
       // saveFile.setOrderId(orderId);
        saveFile.setSize(size / 1024); // 单位 kb
        saveFile.setUrl(url);
        saveFile.setMd5(md5);
        saveFile.setUserId(id);
...
//    }
    ...
    public Result findPage(@RequestParam Integer pageNum,
        ...
        if (!"".equals(userId)) {
            queryWrapper.eq("user_id", userId).or().isNull("user_id");
        }
